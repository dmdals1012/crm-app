...
def add_bg_from_local(image_file):
    ...
    .stApp {{
        ...
        background-size: 50% auto;  /* 이미지 크기를 50%로 줄임 */
    ...
    .stApp::before {{
        ...
        width: 100%;
        height: 100%;
        background-color: rgba(255, 255, 255, 0.8);  /* 투명도를 0.8로 높임 */
        z-index: -1;
    }}
    .css-1d391kg {{
        background-color: rgba(255, 255, 255, 0.7);  /* 컨텐츠 배경 투명도 조정 */
        padding: 20px;
        border-radius: 10px;
    }}
    </style>
...
def home_page():
    ...
    add_bg_from_local('image/title2.webp')
